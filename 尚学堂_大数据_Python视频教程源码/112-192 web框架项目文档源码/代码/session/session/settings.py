...
from django.conf.global_settings import SESSION_SERIALIZER, SESSION_ENGINE, SESSION_FILE_PATH, SESSION_COOKIE_NAME, \
    STATICFILES_DIRS
...
SECRET_KEY = '28i=nnn(##-jhh%)zq&n_g#xkg@lh^9g964d(%p!=!6-e(1-a8'
